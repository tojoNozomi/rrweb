<script lang="ts">
  import { EventType } from 'rrweb-custom';
  import type { Replayer } from 'rrweb-custom';
  import type { playerMetaData } from 'rrweb-custom/typings/types';
  import type {
    PlayerMachineState,
    SpeedMachineState,
  } from 'rrweb-custom/typings/replay/machine';
  import {
    onMount,
    onDestroy,
